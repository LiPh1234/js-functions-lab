...
// let reverse = "" //(this empty string is an accumulator)
...
// this also implements indexing of the individual letters in the word.The last letter in rockstar is rockstar[string.length-1]
